...
class EditorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create editor" do
    assert_difference("Editor.count") do
      post editors_url, params: { editor: { age: @editor.age, email: @editor.email, name: @editor.name } }
    end
  ...
  test "should update editor" do
    patch editor_url(@editor), params: { editor: { age: @editor.age, email: @editor.email, name: @editor.name } }
